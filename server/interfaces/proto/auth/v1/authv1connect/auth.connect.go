...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		createUser: connect.NewClient[v1.UserRequest, v1.UserResponse](
			httpClient,
...
func (c *authServiceClient) CreateUser(ctx context.Context, req *connect.Request[v1.UserRequest]) (*connect.Response[v1.UserResponse], error) {
